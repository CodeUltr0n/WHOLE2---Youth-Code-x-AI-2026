    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            const fetchedUserData = {
                ...
                streetAddress: '123 E-Commerce Blvd',
                apartment: 'Apt 4B',
                city: 'New York',
                postalCode: '10001',
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="md:col-span-2 flex flex-col">
                    ...
                    <input
                        ...
                        className="border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
                    />
                    <small className="text-gray-400 mt-1">For delivery updates</small>
                </div>
                <div className="md:col-span-2 mt-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-4 border-b pb-2">Shipping Address</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="md:col-span-2 flex flex-col">
                            <label htmlFor="streetAddress" className="mb-2 font-medium text-gray-700">Street Address</label>
                            <input
                                id="streetAddress"
                                type="text"
                                name="streetAddress"
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="apartment" className="mb-2 font-medium text-gray-700">Apartment / Suite</label>
                            <input
                                id="apartment"
                                type="text"
                                name="apartment"
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="postalCode" className="mb-2 font-medium text-gray-700">Postal Code</label>
                            <input
                                id="postalCode"
                                type="text"
                                name="postalCode"
