...
const EmptyCart = () => {
  const suggestions = [
    ...
    },
    {
      ...
      description: "Trending global styles and footwear",
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600">
                Every product is carefully authenticated and sourced from top global brands
              </p>
            </div>
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600">
                Fast, reliable delivery straight to your door, anywhere in the world
              </p>
            </div>
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600">
                Your transactions are protected by industry-leading encryption and security
              </p>
            </div>
          </div>
        </div>
