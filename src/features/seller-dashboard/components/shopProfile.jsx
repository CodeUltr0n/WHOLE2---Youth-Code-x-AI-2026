    ...
    useEffect(() => {
        const fetchSellerProfile = async () => {
            const mockDataFromDB = {
                shopName: "Julia's Global Deals",
                artisanName: user.name,
                email: 'julia.k@globaldeals.com',
                phone: '+1 (555) 987-6543',
                bio: "Specializing in authenticated smartphone brands, premium audio gear, and top-tier consumer electronics. Every product is guaranteed to meet the highest global quality standards.",
                shopImageUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=200&auto=format&fit=crop'
            };
        ...
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-2 text-lg">Manage your global storefront and listings</p>
                </div>
                <button
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label htmlFor="artisanName" className="block mb-2 font-semibold text-gray-700">Seller Name</label>
                        <input
                            id="artisanName"
                            name="artisanName"
                            type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border border-gray-300 rounded-md p-3 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition hover:border-indigo-400"
                        />
                        <p className="mt-1 text-sm text-gray-500">For business inquiries.</p>
                    </div>
                </div>
                <div className="mb-6">
