    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-8 mt-4">
        <div className="flex flex-col items-center mb-10">
          <div className="bg-[#FF4500] text-white font-extrabold px-6 py-2 rounded-full text-lg md:text-xl tracking-wide w-fit mx-auto mb-4 shadow-lg drop-shadow-md">
            Discover Indian Origins
          </div>
          <p className="text-center text-gray-500 max-w-md text-sm font-light tracking-wide">
            Our AI-powered stores scale globally for any catalog. Here, we showcase how our platform beautifully connects Indian heritage with digital commerce.
          </p>
        </div>
        {/* Regional Filter */}
        <div className="flex flex-col items-start mb-10">
          <h3 className="font-semibold text-lg mb-3">Browse by Region</h3>
              ...
              >
                ...
                {region.states && (
                  <span className={`text-xs ml-2 font-medium ${
                    activeRegion === region.name ? 'text-white/80' : 'text-black'
                  }`}>
                    {region.states}
                  </span>
                )}
