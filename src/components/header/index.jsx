...
const Header = () => {
  ...
  return (
    <header className="shadow-sm bg-[#FDF8F5]">
      {/* Promotional Strip */}
      <div className="bg-orange-100 text-orange-800 py-2 overflow-hidden">
        <div className='marquee whitespace-nowrap'>
            <span className='mx-4 text-sm font-semibold'>Welcome to (WHOLE)²! Discover exclusive global tech and premium lifestyle brands today.</span>
            <span className="mx-4 text-sm font-semibold">Welcome to (WHOLE)²! Discover exclusive global tech and premium lifestyle brands today.</span>
            <span className="mx-4 text-sm font-semibold">Welcome to (WHOLE)²! Discover exclusive global tech and premium lifestyle brands today.</span>
        </div>
      </div>
      ...
      {/* Main Navigation Bar */}
      <div className="bg-[#FDF8F5] border-b border-gray-200 sticky top-0 z-50">
        <div className="w-full flex items-center justify-between px-5 lg:px-6 py-3">
          <div className="flex items-center gap-8">
            <Link to="/" className="flex-shrink-0">
              <div className="bg-[#FF4500] text-black font-extrabold px-4 py-1.5 opacity-90 rounded-[20px] text-lg tracking-wider shadow-md hover:scale-105 transition-transform duration-200 cursor-pointer">
                (WHOLE)²
              </div>
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            {isLoggedIn ? (
              ...
              <>
                ...
                <AISearchWidget search={search} setSearch={setSearch} />
                ...
                <UserDropdown 
                  user={{
                    name: user?.name || "Julia's Global Deals",
                    email: user?.email || "julia.k@globaldeals.com",
                    // avatar: user?.avatar || "https://ui-avatars.com/api/?name=" + encodeURIComponent(user?.name || "Julia's Global Deals")
